            ...
            if (label == 'smb') {
              ...
              switch(context.raw[2]){
                ...
                case "IOB":
                  ...
                  break;
                case "UAM":
                  text = "Unannounced meals means that a significant increase in glucose levels due to meals, adrenaline or other influences is detected. Prediction line is similar to the ORANGE COB line but it assumes that the deviations will taper down at a constant rate (by extending the current rate of reduction).";
                  break;
                case "ZT":
